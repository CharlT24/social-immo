...
urlpatterns = [
    ...
    path('api/reservation/', views.envoyer_reservation, name='envoyer_reservation'),
    path('reservation/<int:reservation_id>/repondre/', views.repondre_reservation, name='repondre_reservation'),
    path('disponibilites/bloquer/', views.bloquer_periode, name='bloquer_periode'),
    path('disponibilites/<int:periode_id>/debloquer/', views.debloquer_periode, name='debloquer_periode'),
